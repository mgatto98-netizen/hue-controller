...
class AppHueMejorada(Gtk.Window):
    def __init__(self):
        super().__init__(title="Philips Hue Controller v12.1 - Control de Luces y Sensores")
    ...
    def crear_interfaz(self):
        ...
        lbl_bat_icon = Gtk.Label(label="🔋")
        lbl_bat_text = Gtk.Label(label="Estado de baterías")
        hbox_btn.pack_start(lbl_bat_icon, False, False, 0)
