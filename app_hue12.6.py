...
class AppHueMejorada(Gtk.Window):
    def __init__(self):
        super().__init__(title="Philips Hue Controller v12.6 - Control de Luces y Sensores")
    ...
    def crear_interfaz(self):
        ...
        # Ícono de batería como Gtk.Image (compatible con binarios compilados)
        self._bat_color = (0.2, 0.8, 0.2)  # verde por defecto
        self._bat_nivel = 100
        self._bat_image = Gtk.Image()
        self._bat_image.set_size_request(32, 18)
