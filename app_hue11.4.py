...
class AppHueMejorada(Gtk.Window):
    ...
    def crear_interfaz(self):
        ...
        self.sidebar_paned = Gtk.Paned(orientation=Gtk.Orientation.VERTICAL)
        self.sidebar_paned.set_wide_handle(True)

        # Panel superior: habitaciones
        box_habitaciones = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=0)
        ...
        box_habitaciones.pack_start(label_habitaciones, False, False, 0)
        box_habitaciones.pack_start(self.scroll_habitaciones, True, True, 0)
        self.sidebar_paned.pack1(box_habitaciones, True, True)

        # Panel inferior: sensores
        self.sensores_frame = Gtk.Frame(label="🌡️ Sensores de Temperatura")
        self.sensores_frame.set_margin_top(5)
        self.sensores_frame.set_margin_bottom(5)

        self.sensores_box = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=5)
        self.sensores_box.set_margin_top(8)
        self.sensores_box.set_margin_bottom(8)
        self.sensores_box.set_margin_start(8)
        self.sensores_box.set_margin_end(8)

        self.sensores_scroll = Gtk.ScrolledWindow()
        self.sensores_scroll.set_policy(Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
        self.sensores_scroll.set_min_content_height(80)
        ...
        self.sidebar_paned.pack2(self.sensores_frame, False, True)

        self.sidebar.pack_start(self.sidebar_paned, True, True, 0)
            ...
            for luz in luces_room:
                ...
                if luz['id'] in self.sliders_luces:
                    if nuevo_estado:
                        ...
                        if brillo == 0:
                            brillo = 50
                        self.sliders_luces[luz['id']].set_value(brillo)
