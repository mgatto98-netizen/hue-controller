...
class AppHueMejorada(Gtk.Window):
    ...
    def crear_control_luz(self, luz):
        ...
        # Slider de brillo - Convertir de rango 0-254 a 0-100
        ...
        # Guardar referencia del slider para actualizaciones posteriores
    ...
    def on_toggle_luz(self, widget, luz, btn_widget):
        ...
        try:
            if luz.on:
                ...
                # Actualizar el slider a 0 cuando se apaga
                if hasattr(self, 'sliders_luces') and luz in self.sliders_luces:
                ...
                # Restaurar el brillo anterior cuando se enciende
