...
class AppHueMejorada(Gtk.Window):
    def __init__(self):
        super().__init__(title="Philips Hue Controller v12.2 - Control de Luces y Sensores")
    ...
    def crear_interfaz(self):
        ...
        self.lbl_bat_icon = Gtk.Label(label="🔋")
        lbl_bat_text = Gtk.Label(label="Estado de baterías")
        hbox_btn.pack_start(self.lbl_bat_icon, False, False, 0)
        ...
        try:
            ...
            if resultados:
                ...
                if peor < 5:
                    ...
                    icono = "🟢"
                GLib.idle_add(self.lbl_bat_icon.set_text, icono)
