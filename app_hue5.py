...
class AppHueMejorada(Gtk.Window):
    ...
    def actualizar_interfaz_grupos(self):
        ...
        for grupo_id, grupo in grupos_ordenados:
            ...
            # Switch de control para toda la habitación
    ...
    def on_habitacion_switch_toggled(self, switch, gparam, grupo_id):
        ...
        if not grupo['luces']:
            # Si no hay luces, revertir el switch
            switch.set_active(False)
            return
        
        try:
            # Cambiar estado de todas las luces de la habitación
            for luz in grupo['luces']:
                luz['objeto'].on = nuevo_estado
            
            # Actualizar los switches individuales si esta habitación está seleccionada
            ...
            # Actualizar los sliders de brillo
            if self.habitacion_actual == grupo_id:
                for luz in grupo['luces']:
                    if luz['objeto'] in self.sliders_luces:
                        if nuevo_estado:
                            # Si se enciende, restaurar brillo
                            ...
                            # Si se apaga, poner slider a 0 y deshabilitar
    ...
    def on_luz_switch_toggled(self, switch, gparam, luz):
        ...
        try:
            ...
            # Actualizar el switch de la habitación en el sidebar
